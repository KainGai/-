...
- (ButtonView *)shareToNetwork
{
    ...
    bv = [[ButtonView alloc]initWithText:@"QQ/空间" image:[UIImage imageNamed:@"ShareIcon_QQ"] handler:^(ButtonView *buttonView)
          {
              //QQ
              [QQSDKTool shareToWeiboWithImage:[ImageUtilityTool imageFromScrollView:self.webView.scrollView] title:self.newsModel.title description:[NSString stringWithFormat:@"由【桂林理工大學-校園手機應用】转码 本文来源:%@",self.articleURL]];
