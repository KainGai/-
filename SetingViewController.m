...
- (void)viewDidLoad {
    ...
    [self initTableView];
    //@"觉得不错？",@"应用内评分",@"关注作者",
    self.contentArray = @[@"桂林理工大學",@"意见反馈",@"现已开源",@"感谢开源"];
...
//            NSDictionary *infoDictionary = [[NSBundle mainBundle] infoDictionary];
            [[InformationHandleTool sharedInfoTool] sendEmailWithSubject:@"使用桂林校園手機應用的建議反饋" MessageBody:@"我正在使用桂林校園手機應用,\n我的反饋和建議：\n1、\n2、\n3、" isHTML:NO toRecipients:@[@"guanxuwudilou@163.com"] ccRecipients:nil bccRecipients:nil  Image:nil imageQuality:0 Controller:self];
...
//            break;
        case 2:
            [[InformationHandleTool sharedInfoTool] inSafariOpenWithURL:@"https://github.com/KainGai/Campus-App-"];
            break;
        case 3:{
